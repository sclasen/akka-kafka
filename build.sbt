...
version := "0.0.9-0.8.2-beta-SNAPSHOT"
...
libraryDependencies += "com.typesafe.akka" %% "akka-slf4j" % "2.3.6" % "test,it"

libraryDependencies +=   "org.apache.kafka" %% "kafka"  %"0.8.2-beta" exclude("log4j", "log4j") exclude("org.slf4j","slf4j-log4j12")
